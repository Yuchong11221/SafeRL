...
class MPSC_SIM():
    ...
    def step_optimizer(self):
        ...
        for i in range(horizons_step):
            ...
            next_state = self.dfdx_matrix @ z_var[:,i] + self.dfdu_matrix @ v_var[:,i]
        ...
        # equation 5-f
        # print("lqr_gain is")
        # print(self.compute_lqr_gain().shape)
        # print((self.compute_lqr_gain()@(x-z_var[:,0])).shape)
